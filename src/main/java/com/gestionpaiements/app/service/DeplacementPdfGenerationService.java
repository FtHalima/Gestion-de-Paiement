...
public class DeplacementPdfGenerationService {
    ...
    //private static final Color YELLOW = new DeviceRgb(255, 255, 0); // Yellow for title
...
*/
    ...
    private void addIdentificationBlock(Document document, Professeur prof) {
        ...
        String cadre = prof != null ? getFieldValue(prof.getGrade()) : ""; // This is "Cadre" in user spec
        String grade = prof != null && prof.getEchelle() != null ? prof.getEchelle().toString() : ""; // This is "Grade" in user spec
        ...
        // Ligne 1 : Présenté par: M, Mme: (Bold) [value]     PPR: (Bold) [value]
        table.addCell(cellNoBorderIdentificationLeft(new Paragraph()
                .add(new com.itextpdf.layout.element.Text("Présenté par: M, Mme: ").setFont(calibriBold))
                .add(new com.itextpdf.layout.element.Text(nomComplet).setFont(calibriRegular))));
        ...
        // Ligne 2 : CNI: (Bold) [value]     Cadre: (Bold) [value]
        table.addCell(cellNoBorderIdentificationLeft(new Paragraph()
                .add(new com.itextpdf.layout.element.Text("CNI: ").setFont(calibriBold))
        ...
        // Ligne 3 : Grade: (Bold) [value] (full width, centered)
        ...
        // Ligne 4 : Lieu de travail: (Bold) [value]     Compte N°: (Bold) [value] (with valeur du compte centrée)
        table.addCell(cellNoBorderIdentificationLeft(new Paragraph()
        ...
        table.addCell(cellNoBorderIdentificationRight(new Paragraph()
                ...
                .setTextAlignment(TextAlignment.CENTER)); // Center the value within the cell
        ...
        table.addCell(cellNoBorderIdentificationRight(new Paragraph()
                .add(new com.itextpdf.layout.element.Text("Compte N°: ").setFont(calibriBold))
                .add(new com.itextpdf.layout.element.Text(compteN).setFont(calibriRegular)))
                .setTextAlignment(TextAlignment.CENTER)); // Center the content of this cell (label + value)
               */
        
        Cell gradeCell = new Cell(1, 2).add(new Paragraph()
                .add(new com.itextpdf.layout.element.Text("Compte N°: ").setFont(calibriBold))
                .add(new com.itextpdf.layout.element.Text(compteN).setFont(calibriRegular)))
                .setBorder(Border.NO_BORDER)
                .setTextAlignment(TextAlignment.CENTER)
